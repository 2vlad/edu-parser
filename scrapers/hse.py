...
HSE_TARGET_PROGRAMS = [
    ...
    "ОНЛАЙН Социальная аналитика",
    "ОНЛАЙН Экономика данных",
    "ОНЛАЙН Математические методы моделирования и компьютерные технологии",
    "ОНЛАЙН Программная инженерия",
    "ОНЛАЙН Системы искусственного интеллекта",
    "ОНЛАЙН Технологии программирования",
    "ОНЛАЙН Цифровые технологии в бизнесе",
    "ОНЛАЙН Цифровое право и информационная безопасность",
    "ОНЛАЙН Корпоративные финансы и инвестиции",
    "ОНЛАЙН Прикладная математика и информатика",
    "ОНЛАЙН Управление данными"
]
